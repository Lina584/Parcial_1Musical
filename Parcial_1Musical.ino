...
// Verifica que el Bluetooth esté habilitado en tu build de ESP32
#if !defined(CONFIG_BT_ENABLED) || !defined(CONFIG_BLUEDROID_ENABLED)
#error Bluetooth no está habilitado. Ve a Herramientas > Partition Scheme y elige uno con Bluetooth, o revisa tu core de ESP32.
#endif
...
// =====================================================
// INTERPRETAR FRASE
// (misma lógica de siempre, sin importar si vino por
//  Serial USB o por Bluetooth)
// =====================================================
...
void interpretar(String frase) {
  ...
  // Confirmación por Bluetooth (útil para ver en la app
  // qué entendió la ESP32, además de la OLED)
...
void setup() {
  ...
  // Este es el nombre que verás al buscar dispositivos
  // Bluetooth desde tu celular. Cámbialo si quieres.
  SerialBT.begin("AsistenteMusical");

  Serial.println("Bluetooth listo. Empareja con 'AsistenteMusical'");
  ...
  Serial.println();
  Serial.println("================================");
  Serial.println("      ASISTENTE MUSICAL");
  Serial.println("================================");
  Serial.println("Escribe una frase (Serial o Bluetooth).");
  Serial.println("Ejemplo: Toca el bombo");
  Serial.println();

  SerialBT.println("Asistente musical listo. Habla o escribe un comando.");
}
...
void loop() {
  ...
  // ---------------------------------------------------
  // COMANDOS POR USB (para pruebas de escritorio)
  // ---------------------------------------------------
  ...
  // ---------------------------------------------------
  // COMANDOS POR BLUETOOTH (voz desde el celular)
  // ---------------------------------------------------

  if (SerialBT.available() > 0) {

    String frase = SerialBT.readStringUntil('\n');
